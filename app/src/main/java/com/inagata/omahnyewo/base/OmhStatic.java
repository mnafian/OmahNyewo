...
public class OmhStatic {
    ...
    //link url
    public static final String URL_WS = "http://103.27.250.31/omahnyewo/servicelist.php?type=";
    public static final String IMAGE_URL_WS = "http://103.27.250.31/omahnyewo/res/";
